      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="col-span-1">
          <div className="rounded-2xl bg-card border border-border p-6 flex flex-col items-center gap-4 text-center">
            ...
            {/* Info rows */}
            <div className="w-full flex flex-col gap-3 pt-2 border-t border-border">
              {email && (
            ...
            <button
              ...
              disabled
              title="Próximamente"
              className="w-full border border-border rounded-full py-2 text-[11px] font-black uppercase tracking-[0.15em] text-zinc-400 cursor-not-allowed opacity-50"
            >
              Editar foto
            </button>
          </div>
