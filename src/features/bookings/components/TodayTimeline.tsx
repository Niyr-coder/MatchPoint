  ...
  return (
    <div className="flex flex-col gap-2">
      {sorted.map((r, i) => (
        <div
          key={r.id}
          className="animate-fade-in-up-8 rounded-2xl bg-card border border-border px-5 py-4 flex items-center gap-4"
        ...
        >
          ...
          {r.status === "pending" && (
            <button
              ...
              className="shrink-0 flex items-center gap-1.5 bg-foreground hover:bg-foreground/90 text-white rounded-full px-3 py-1.5 text-[10px] font-black uppercase tracking-wide transition-colors disabled:opacity-50"
            >
