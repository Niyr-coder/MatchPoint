  ...
  return (
    <div ref={panelRef} className="relative">
      <button
        ...
        aria-haspopup="true"
        className="relative p-2 rounded-full text-zinc-400 hover:text-white hover:bg-white/10 transition-colors duration-200"
      >
          ...
          <div className="flex items-center justify-between px-4 py-3 border-b border-border-subtle">
            ...
            {notifications.length > 0 && (
              <button
                ...
                className="flex items-center gap-1 text-[10px] font-bold text-[#737373] hover:text-foreground transition-colors disabled:opacity-40"
              >
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-start justify-between gap-2">
                        ...
                        {!n.read && (
                          <span className="size-2 rounded-full bg-secondary shrink-0 mt-1" />
                        )}
                      </div>
          ...
          {notifications.length > 0 && (
            <div className="px-4 py-2.5 border-t border-border-subtle">
              <a
                ...
                className="block text-center text-[11px] font-black uppercase tracking-wide text-[#737373] hover:text-foreground transition-colors"
              >
                Ver todas
              </a>
            </div>
